...
- Success criteria: <live check, walkthrough, artifact, metric, source-backed answer, or decision that keeps pressure on the goal>
- Likely misfire: <how Cursor Curator could succeed at the wrong thing>
