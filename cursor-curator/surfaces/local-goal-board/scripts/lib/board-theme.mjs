...
export const BOARD_SKIN_COPY = {
  ...
  "field-notes": {
    ...
    sections: {
      ...
      changedFiles: "Changed files",
      commands: "Commands",
      subgoal: "Sub-objective sketch (read-only)",
...
:root[data-skin="control-room"] .modal-panel {
  color: #141c26;
  background: var(--modal-surface);
}

:root[data-skin="control-room"] .modal-panel .eyebrow,
:root[data-skin="control-room"] .modal-panel h2,
:root[data-skin="control-room"] .modal-panel h3,
:root[data-skin="control-room"] .modal-panel p,
:root[data-skin="control-room"] .modal-panel li,
:root[data-skin="control-room"] .modal-panel dd {
  color: #141c26;
}

:root[data-skin="control-room"] .modal-panel .detail-item dt {
  color: #6b7f94;
}
...
:root[data-skin="field-notes"] .subgoal-section {
  border-style: dashed;
}
...
:root[data-skin="proof-ledger"] .subgoal-section {
  box-shadow: none;
}
...
:root[data-skin="relay-map"] .modal-panel .eyebrow,
:root[data-skin="relay-map"] .modal-panel h2,
:root[data-skin="relay-map"] .modal-panel h3,
:root[data-skin="relay-map"] .modal-panel p,
:root[data-skin="relay-map"] .modal-panel li,
:root[data-skin="relay-map"] .modal-panel dd {
  color: #0f1a2e;
}
